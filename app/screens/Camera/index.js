...
import { Text, View, StatusBar, Image, TouchableOpacity, Modal, NativeModules } from 'react-native';
                ...
                <Modal
                    ...
                    <View style={{marginTop: 22}}>
                        <View>
                            ...
                            <TouchableHighlight onPress={() => { this.setState({this.state.showModal: !this.state.showModal}) }}>
